...
const Dokter = () => {
  ...
  useEffect(() => {
    // Nanti diganti: axios.get('/api/dokter')
    setTimeout(() => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {dokterFiltered.map((d) => (
              ...
              >
                ...
                {/* Spesialis */}
                <span className="text-xs text-blue-600 font-medium bg-blue-50 px-3 py-1 rounded-full mb-3">
                  {d.spesialis.nm_sps}
                </span>

                {/* Poli */}
                <p className="text-sm text-gray-500 mb-4">
                  🏥 {d.poliklinik.nm_poli}
                </p>
